...
const ConfirmResetPassword = ({ toggleOpenPopup, id }) => {
  ...
  return (
    <form className="form" onSubmit={handleSubmit(onSubmit)}>
      <h4 className="form-title">Создать новый пароль</h4>
      ...
      <div className="form-bottom">
        <Button type="submit" isLoading={isSubmitting} className="form-btn gray">Создать новый пароль</Button>
      </div>
    </form>
  )
};
